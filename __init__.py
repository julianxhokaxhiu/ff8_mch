...
class MchHeader_class:
    """Class defining all adresses and values of MCH header:
        ...
        -ObOffset;
        -AnimOffset;
        -Unk2Offset;//unknown data type 2
        -AnimCount;"""
...
#    for i in range(0,header.BoneCount):
#        parent_name=boneList[boneList[i].parent].name
#        if(i==0):
#            boneList[i].name="root"
#        elif(i==1):
#            boneList[i].name="upper_body"
#        elif(i==2):
#            boneList[i].name="lower_body"
#        elif (boneList[i].parent==1):
#            if(boneList[i].Chainlength<4):
#                if poseList[i].rotZ==0x1000:
#                    boneList[i].name="neck"
#                else:
#                    boneList[i].name="collar{}".format(collarCount)
#                    collarCount+=1
#            elif(boneList[i].Chainlength>=4):#breast
#                if(boneList[i].Chainlength<=5):
#                    if(poseList[i].rotX>0x800):
#                        boneList[i].name="breast_L"
#                    else:
#                        boneList[i].name="breast_R"
#                else:
#                        boneList[i].name="cape{}".format(capeCount)
#                        capeCount+=1
#
#        elif (parent_name[0:4]=="cape"):#cape
#            boneList[i].name="cape{}".format(capeCount)
#            capeCount+=1
#        elif (parent_name[0:4]=="coll"):#collar
#            boneList[i].name="collar{}".format(collarCount)
#            collarCount+=1
#
#        elif (parent_name=="neck"):#head
#            boneList[i].name="head"
#        elif (parent_name=="head")or(parent_name[0:4]=="hair"):#hair
#            boneList[i].name="hair{}".format(hairCount)
#            hairCount+=1
#
#        elif (parent_name=="breast_R"):#right shoulder
#            boneList[i].name="shoulder_R"
#        elif (parent_name=="breast_L"):#left shoulder
#            boneList[i].name="shoulder_L"
#
#        elif (parent_name=="shoulder_R"):#right arm
#            boneList[i].name="arm_R"
#        elif (parent_name=="shoulder_L"):#leftarm
#            boneList[i].name="arm_L"
#
#        elif (parent_name=="arm_R"):#right forearm
#            boneList[i].name="forearm_R"
#        elif (parent_name=="arm_L"):#left forearm
#            boneList[i].name="forearm_L"
#
#        elif (parent_name=="forearm_R"):#right hand
#            boneList[i].name="hand_R"
#        elif (parent_name=="forearm_L"):#left hand
#            boneList[i].name="hand_L"
#
#        elif (parent_name[0:5]=="weapR")or(parent_name=="hand_R"):#weaponR
#            boneList[i].name="weapR{}".format(weaponRCount)
#            weaponRCount+=1
#        elif (parent_name[0:5]=="weapL")or(parent_name=="hand_L"):#weaponL
#            boneList[i].name="weapL{}".format(weaponLCount)
#            weaponLCount+=1
#
#        elif(boneList[i].parent==2):#hips
#
#            if (boneList[i].Chainlength==3):
#                if(poseList[i].rotX>0x800):
#                    boneList[i].name="hip_L"
#                else:
#                    boneList[i].name="hip_R"
#            else:
#                boneList[i].name="belt{}".format(beltCount)
#                beltCount+=1

#        elif(parent_name[0:4]=="belt"):#belt hanging
#            boneList[i].name="belt{}".format(beltCount)
#            beltCount+=1
#
#        elif (parent_name=="hip_R"):#right thigh
#            boneList[i].name="thigh_R"
#        elif (parent_name=="hip_L"):#left thigh
#            boneList[i].name="thigh_L"
#
#        elif (parent_name=="thigh_R"):#right tibia
#            boneList[i].name="tibia_R"
#        elif (parent_name=="thigh_L"):#left tibia
#            boneList[i].name="tibia_L"
#
#        elif (parent_name=="tibia_R"):#right foot
#            boneList[i].name="foot_R"
#        elif (parent_name=="tibia_L"):#left foot
#            boneList[i].name="foot_L"
#
#        else:#undefined bone
#            boneList[i].name="bone{}".format(i)
    ...
    bpy.ops.object.mode_set(mode='EDIT')
    for eb in armature_rest.data.edit_bones:
        eb.roll=BoneRotations[i].x+math.radians(-90)
    bpy.ops.object.mode_set(mode='OBJECT')
...
def MCH_TO_BLEND(context, filepath=""):
    ...
    #Read Anim
    one_found=0
    onefile=open(dirname(filepath)+"/chara.one","rb")
