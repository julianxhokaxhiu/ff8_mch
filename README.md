...
0. Install [Blender 5.0](https://www.blender.org/download/releases/5-0/)
...
5. Clone this project in the Blender addon path
    ...
    - Mac: `/Users/$USER/Library/Application Support/Blender/5.0/scripts/addons/`
    - Linux: `$HOME/.config/blender/5.0/scripts/addons/`
